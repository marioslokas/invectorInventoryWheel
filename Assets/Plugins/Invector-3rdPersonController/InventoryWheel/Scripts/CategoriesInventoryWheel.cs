...
namespace Invector
{
    ...
    public class CategoriesInventoryWheel : MonoBehaviour
    {
        #region Variables
        ...
        //void BuildCategoryWheel()
        //{
        //    if (categories == null || categories.Length <= 0)
        //        return;

        //    // calculate fill amount depending on the amount of categories
        ...
        //        // create item
        //        GameObject IWheelItem = new GameObject(category.NameDisplay);
        ...
        //        InventoryWheelCategoryItem IWheelItemScript = IWheelItem.AddComponent<InventoryWheelCategoryItem>();
        ...
        //        IWheelItemScript.CachedImage.sprite = category.DisplaySprite; //Item.icon;
